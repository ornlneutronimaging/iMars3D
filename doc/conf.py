...
ornl = u'Oak Ridge National Laboratory'
project = u'iVenus'
copyright = u'2015, ' + project + ' Team, ' + ornl
author = project + ' Team'
...
texinfo_documents = [
  ...
  ornl,
  project,
  'Neutron imaging data analysis at ORNL.',
  'Miscellaneous'),
]
...
MOCK_MODULES = [
    ...
    'matplotlib', 'matplotlib.pylab', 'tifffile', 'scikit-image',
    'skimage']
